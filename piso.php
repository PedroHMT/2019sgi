...
$query2 = mysqli_query($conexao, $sql_06);
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="mercado.php"> Mercado de Trabalho</a>
								<span class="lnr lnr-arrow-right"></span>
								<a href="piso.php"> Piso Salarial</a></p>
						</div>	
					</div>
				</div>
			</section>
						...
						<?php 
							...
							<div class="single-post row">
								...
								<div class="col-lg-12 col-md-9">
									<h3 class="center-text mt-20 mb-20">Piso Salarial: Tecnólogo em Segurança da Informação</h3>
									<table class="grade_table">
										<tr>
											<td class="grade_tr">Cargo</td>
											<td class="grade_tr">Salário</td>
										</tr>
										<?php while($exibe_grade = mysqli_fetch_array($query2)){?>
										<tr>
											<td class="grade_tr1"><?php echo $exibe_grade[1]?></td>
											<td class="grade_tr1"><?php echo "R$ ".number_format($exibe_grade[2], 2, ',', '.'); }?></td>
										</tr>
									</table>
								</div>
							</div><?php } ?>
