				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="about.php"> Sobre o Curso</a></p>
						</div>	
					</div>
				</div>
			</section>
							...
							<div class="single-post row">
								<div class="col-lg-12">
									<div class="feature-img">
										<img class="img-fluid" src="img/blog/<?php echo $exibir_blog[3]?>" alt="">
									</div>									
								</div>
								<div class="col-lg-12 col-md-9">
									<h3 class="center-text mt-20 mb-20"><?php echo $exibir_blog[1] ?></h3>
									<p class="excert paragrafo_estilizado">
										<?php echo $exibir_blog[2]; ?>
									</p>
								</div>
							</div><?php } ?>
						</div>
