...
<!DOCTYPE html>
	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Segurança da Informação - Perfil</title>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="perfil.php"> Perfil Profissional</a></p>
						</div>	
					</div>
				</div>
			</section>
						...
						<div class="col-lg-8 posts-list">
							<div class="single-post row">
								...
								<div class="col-lg-12 col-md-9">
									<h3 class="center-text mt-20 mb-20">Perfil Profissional: Segurança da Informação</h3>
										<div class="border-top-perfil">
											<div class="row">
												<?php
													while($result = mysqli_fetch_array($query)){?>
												<div class="col-md-4">
													<div class="perfil single-defination mb-20">
														<div class="perfil-img">
															<img class="perfil-img" src="img/perfil/<?php echo $result[2]?>">
															<h4 class="perfil"><?php echo $result[1]?></h4>
														</div>
													</div>
												</div>
												<?php } ?>
