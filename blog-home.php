<?php
	...
	$query = mysqli_query($conexao, $sql_01); 
			...
			<section class="post-content-area">
				<div class="container">
					<div class="row">
						...
						<?php while($exibir = mysqli_fetch_array($query))
						{?>
								...
								<div class="col-lg-3  col-md-3 meta-details">
									...
									<div class="user-details row">
												<p class="user-name col-lg-12 col-md-12 col-6"><a href="#">
													<?php echo $exibir[10]?></a> <span class="lnr
													lnr-user"></span></p>
													<p class="date col-lg-12 col-md-12 col-6"><a href="#"><?php echo date('d/m/Y', strtotime($exibir[3]))?>, <?php echo	date('H:i', strtotime($exibir[3]))?></a> <span class="lnr lnr-calendar-full"></span></p>
													<p class="view col-lg-12 col-md-12 col-6"><a href="#">1.2M Views</a> <span class="lnr lnr-eye"></span></p>
													<p class="comments col-lg-12 col-md-12 col-6"><a href="#">06 Comments</a> <span class="lnr lnr-bubble"></span></p>				
									</div>
								</div>
								<div class="col-lg-9 col-md-9">
									<div class="feature-img"><img class="img-fluid" src="img/blog/<?php echo $exibir[6]?>">
									</div>		
									<a class="posts-title" href="blog-single.php?notice=<?php echo $exibir[0]?>"><h3><?php echo utf8_encode($exibir[1])?></h3></a>
									<p class="excert"><?php echo substr(utf8_encode($exibir[2]),0,200)?></p>
									<a href="blog-single.php?notice=<?php echo $exibir[0]?>" class="primary-btn">View More</a>
								</div>
							</div>
							<?php } ?>
