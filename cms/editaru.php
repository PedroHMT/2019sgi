<?php
  ...
  $query = mysqli_query($conexao, "SELECT * FROM universidades WHERE uni_cod=".$_GET['id']);
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="editar_universidades.php">Página: Universidades</a></li>
            </ul>
          </li>
          <!--
          <li class="sub-menu">
        ...
        <div class="row mt">
            <div class="col-lg-9">
              <div class="form-panel">
                <h4 class="mb"><i class="fa fa-angle-right"></i> Universidades</h4>
                <form class="form-horizontal style-form" enctype="multipart/form-data"  action="funcoes/editaru.php" method="POST">
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Título</label>
                    <div class="col-sm-5">
                      <input type="hidden" name="uni_cod" class="form-control" value="<?php echo $exibir[0] ?>">
                      <input type="text" name="uni_titulo" class="form-control" value="<?php echo $exibir[1]?>">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      ...
                      <img src="../img/universidades/<?php echo $exibir[4] ?>" alt="" />
                      </div>
