<?php 
  ...
  $query = mysqli_query($conexao, "SELECT * FROM perfil");
?>
<!DOCTYPE html>
<html lang="en">
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> Perfil do Profissional</h4>
                <hr>
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="editarperf.php?id=<?php echo $exibir[0] ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
