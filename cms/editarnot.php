<?php
  ...
  $query = mysqli_query($conexao, $sql_02.$_GET['noticia']);
  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="editar.php">Editar Notícia</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Gerenciamento de Noticias</h3>

        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
            <div class="col-lg-9">
              <div class="form-panel">
                <h4 class="mb"><i class="fa fa-angle-right"></i> Editar Noticia</h4>
                <form class="form-horizontal style-form" action="funcoes/editar.php" method="POST">
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Título</label>
                    <div class="col-sm-5">
                      <input type="hidden" name="Blog_Codigo" class="form-control" value="<?php echo $exibir[0] ?>">
                      <input type="text" name="Blog_Titulo" class="form-control" value="<?php echo $exibir[1] ?>">
                    </div>
                  </div>
                  <div class="form-group">
                      <label class="col-sm-2 col-sm-2 control-label">Texto</label>
                      <div class="col-sm-5">
                        <textarea type="text" name="Blog_Corpo" class="form-control" rows="10"><?php echo $exibir[2] ?></textarea>
                      </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-2">
