      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="cadastrar.php">Cadastrar Notícia</a></li>
        ...
        <div class="row mt">
            <div class="col-lg-9">
              <div class="form-panel">
                <h4 class="mb"><i class="fa fa-angle-right"></i> Cadastrar Noticia</h4>
                <form class="form-horizontal style-form" enctype="multipart/form-data" action="funcoes/cadastro.php" method="POST">
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Título</label>
                    <div class="col-sm-5">
                      <input type="text" name="Blog_Titulo" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                      <label class="col-sm-2 col-sm-2 control-label">Texto</label>
                      <div class="col-sm-5">
                        <textarea type="text" name="Blog_Corpo" class="form-control" rows="10"></textarea>
                      </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-sm-2">
                      <input type="submit" class="btn btn-theme col-sm-11 col-lg-12" value="Publicar">
                    </div>
                  </div>
                </form>
              </div>
