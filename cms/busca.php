  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="editar.php">Pesquisar Notícias</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Gerenciamento de Notícias</h3>
        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Pesquisar Notícias</h4>
              <form class="form-horizontal style-form" method="POST" action="result.php">
                <div class="form-group">
                  <div class="col-sm-10">
                    <input type="text" name="pchave" placeholder="Pesquise aqui..." class="form-control">
                  </div>
                </div>
                <div class="form-group last">
                    <div class="col-sm-2">
                      <input type="submit" class="btn btn-theme col-sm-11 col-lg-12" value="Pesquisar">
                    </div>
                  </div>
              </form>
            </div>
