        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="busca.php">Pesquisar Notícias</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    ...
                    <th><i class="fa fa-pencil"></i> Ação</th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
                  <?php
                  $pchave = $_POST['pchave'];
                  $query = mysqli_query($conexao, "SELECT * FROM blog WHERE Blog_Titulo LIKE '%$pchave%'");
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="editarnot.php?noticia=<?php echo $exibir[0] ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                      <a href="funcoes/apagar.php?noticia=<?php echo $exibir[0] ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
