...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.php" class="logo"><b>CMS<span> SGI</span></b></a>
      <!--logo end-->
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="funcoes/logout.php">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="editar_sobre.php">Página: Sobre o Curso</a></li>
   ...
   <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Edição de Template</h3>

        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
            <div class="col-lg-9">
              <div class="form-panel">
                <h4 class="mb"><i class="fa fa-angle-right"></i> Sobre o Curso</h4>
                <form class="form-horizontal style-form" enctype="multipart/form-data"  action="funcoes/editar_sobre.php" method="POST">
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Título</label>
                    <div class="col-sm-5">
                      <input type="hidden" name="Sobre_Cod" class="form-control" value="<?php echo $exibir[0] ?>">
                      <input type="text" name="Sobre_Titulo" class="form-control" value="<?php echo $exibir[1]?>">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      ...
                      <img src="../img/blog/<?php $query_img = mysqli_query($conexao, 'SELECT * from sobre LIMIT 1'); $r = mysqli_fetch_array($query_img); echo $r[3];?>" alt="" />
                      </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <textarea type="text" name="Sobre_Corpo" class="form-control" rows="10"><?php  echo strip_tags($exibir[2]);
                       ?></textarea>
                      </div>
                  </div> 
                <div class="form-group last">
                    <div class="col-sm-2">
                      <input type="submit" class="btn btn-theme col-sm-11 col-lg-12" value="Editar">
                    </div>
                  </div>
